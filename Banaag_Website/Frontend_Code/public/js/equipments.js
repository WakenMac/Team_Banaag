...
async function handleRemarksEquipmentSubmit(e) {
  ...
  let result = await updateLabEquipmentsRemarkByItemId(
    equipmentId,
    remarks
  );
...
async function handleAddEquipmentSubmit(e) {
  ...
  let result = await addLabEquipmentsRecord(
    equipmentName,
    equipmentLocation,
    equipmentUnit,
    equipmentBrand,
...
async function handleEditEquipmentSubmit(e) {
  ...
  let result = await updateLabEquipmentsRecordByAll(
    editEquipmentId,
    editEquipmentName,
    editEquipmentLocation,
    editEquipmentUnit,
...
async function handleDeleteEquipment() {
  if (equipmentRowToDelete) {
    let result = await deleteLabEquipmentsRecordByItemId(
...
async function initializeLabEquipmentsTable() {
  try {
    let data = await getAllLabEquipmentsRecords();
...
async function getAllLabEquipmentsRecords(){
  try {
    let response = await fetch('/lab-equipments/get-all-lab-equipments-records', {
      method: 'GET'
    }); 
...
async function addLabEquipmentsRecord(
  equipmentName,
  equipmentLocation,
  equipmentUnit,
  equipmentBrand,
  ...
  try {
    let response = await fetch('/lab-equipments/add-lab-equipments-records', {
      method: 'POST',
      headers : {
      ...
      body : JSON.stringify({
        ...
        locationName : equipmentLocation, 
        unitTypeName : equipmentUnit, 
        brandModel : equipmentBrand, 
        serialNo : equipmentSerialNumber, 
        calibrationDate : equipmentCalibrationDate, 
        frequencyOfCalibration : equipmentFreqOfCalibration, 
        remarks : remarks
      })
    }); 
...
async function updateLabEquipmentsRemarkByItemId(
  equipmentId,
  remarks
){
  try {
    let response = await fetch('/lab-equipments/update-lab-equipments-remarks', {
      method: 'PATCH',
      headers : {
        'Content-type' : 'application/json'
      },
...
async function updateLabEquipmentsRecordByAll(
  editEquipmentId,
  editEquipmentName,
  editEquipmentLocation,
  editEquipmentUnit,
  ...
  try {
    let response = await fetch('/lab-equipments/update-lab-equipments-records', {
      method: 'PATCH',
      headers : {
        'Content-type' : 'application/json'
      },
      body : JSON.stringify({
        itemId : editEquipmentId, 
        itemName : editEquipmentName, 
        locationName : editEquipmentLocation, 
        unitTypeName : editEquipmentUnit, 
        brandModel : editEquipmentBrand, 
        serialNo : editEquipmentSerialNumber, 
        calibrationDate : editEquipmentCalibrationDate, 
        frequencyOfCalibration : editEquipmentFreqOfCalibration, 
        remarks : remarks
      })
    }); 
...
async function deleteLabEquipmentsRecordByItemId(itemId){
  try {
    let response = await fetch('/lab-equipments/delete-lab-equipments-records', {
      method: 'DELETE',
      headers : {
        'Content-type' : 'application/json'
      },

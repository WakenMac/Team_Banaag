...
async function handleDeleteConsumableItems() {
  if (consumableItemRowToDelete) {
    let result = await deleteConsumableItemsRecordByItemId(
...
async function handleAddConsumableItemSubmit(e) {
  ...
  let result = await addConsumableItemsRecord(
    consumableItemsName,
    consumableItemsLocation,
    consumableItemsUnit,
    consumableItemsBrand,
...
async function handleEditConsumableItemSubmit(e) {
  ...
  let result = await updateConsumableItemsRecordByAll(
    editConsumableItemsId,
    editConsumableItemsName,
    editConsumableItemsLocation,
    editConsumableItemsUnit,
...
async function handleRemarksItemSubmit(e) {
  ...
  let result = await updateConsumableItemsRemarkByItemId(
    consumableItemsId,
    remarks
  );
  result = (result != null)? result.data : null;
...
async function initializeConsumableItemsTable() {
  try {
    let data = await getAllConsumableItemsRecords();
...
async function getAllConsumableItemsRecords(){
  try {
    let response = await fetch('/consumable-items/get-all-consumable-items-records', {
      method: 'GET'
    }); 
...
async function addConsumableItemsRecord(
  consumableItemsName,
  consumableItemsLocation,
  consumableItemsUnit,
  consumableItemsBrand,
  ...
  try {
    let response = await fetch('/consumable-items/add-consumable-items-records', {
      method: 'POST',
      headers : {
        'Content-type' : 'application/json'
      },
      body : JSON.stringify({
        itemName : consumableItemsName, 
        locationName : consumableItemsLocation, 
        unitTypeName : consumableItemsUnit, 
        brandModel : consumableItemsBrand, 
        remarks : remarks
      })
    }); 
...
async function updateConsumableItemsRemarkByItemId(consumableItemsId, remarks){
  try {
    let response = await fetch('/consumable-items/update-consumable-items-remarks', {
      method: 'PATCH',
      headers : {
        'Content-type' : 'application/json'
      },
      body : JSON.stringify({
        itemId : consumableItemsId,
        remarks : remarks
      })
    }); 
...
async function updateConsumableItemsRecordByAll(
  editConsumableItemsId,
  editConsumableItemsName,
  editConsumableItemsLocation,
  editConsumableItemsUnit,
  ...
  try {
    let response = await fetch('/consumable-items/update-consumable-items-records', {
      method: 'PATCH',
      headers : {
        'Content-type' : 'application/json'
      },
      body : JSON.stringify({
        itemId : editConsumableItemsId, 
        itemName :editConsumableItemsName, 
        locationName : editConsumableItemsLocation, 
        unitTypeName : editConsumableItemsUnit, 
        brandModel : editConsumableItemsBrand, 
        remarks : remarks
      })
    }); 
...
async function deleteConsumableItemsRecordByItemId(itemId){
  try {
    let response = await fetch('/consumable-items/delete-consumable-items-records', {
      method: 'DELETE',
      headers : {
        'Content-type' : 'application/json'
      },
